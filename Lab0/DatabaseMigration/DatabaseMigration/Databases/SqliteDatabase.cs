...
namespace DatabaseMigration.Databases
{
    public static class SqliteDatabase
    {
        ...
        /// <summary>
        /// <exception cref="SQLiteException"> Thrown when the SQLite database problem has occured. </exception>
        /// </summary>
        ...
        private static Record ReadRecord(SQLiteDataReader reader) => new()
        {
